...
import { View, Text, StyleSheet, SafeAreaView, StatusBar, Animated, ScrollView, TouchableOpacity } from 'react-native';
...
class DetailProduct extends React.Component<any> {
    ...
    handler={
        sendNavigationToChat:(responseResult)=>{
            ...
            const URL = `${getRouterURLArray("products","product").completeUrl}${product_id}`;
    ...
    componentDidMount() {
        ...
        this.setState({ product_id: product_id, isLoading: true }, this.loadDetailProduct);
    }
    loadDetailProduct = () => {
    ...
    handleResponse(data) {
       ...
       const {isLiked} = data.product;
        ...
        this.setState({ isLiked:isLiked, product: data.product, photos: data.photos, city: data.city,category:data.category }, this.loadComponentPicture)
    }
    ...
    addKeranjangHandler(callbacks) {
        ...
        sendHTTPPOST(completeURL, {}, httpHeader(device, auth), (response) => {
                ...
                <View style={styles.container}>
                    ...
                    <SafeAreaView style={{ position: 'relative' }}>
                        <View style={styles.listContainer}>
                            <View style={[otStyle.navContainer,otStyle.flexRow,{backgroundColor:"rgba(0,0,0,0.0)",position:'absolute',top:0,zIndex:999}]}>
                                <View style={{flex:1,backgroundColor:"rgba(0,0,0,0.0)",justifyContent:'center',alignItems:'flex-start'}}>
                            ...
                            >
                                ...
                                <View style={styles.innerContainer}>
                                    <ImageSlideProduct style={{ position: 'absolute' }} anihead={animationHeader} photos={this.state.photos} />
                                    <View style={styles.itemPaddingWSpace}>
                                        <View style={{
                                            ...
                                            <View style={{
                                                ...
                                                <Text style={styles.textPrice}>IDR. {formatCurrency(this.state.product.price)}</Text>
                                            ...
                                            <View style={{ flexDirection: 'row' }}>
                                                ...
                                                <View style={{ marginLeft: 5 }}>
                                                    ...
                                                    <Text style={{
                                                        ...
                                                        fontWeight: '200',
                                                    }}>{this.state.category.kategori}</Text>
                                                </View>
                                            </View>
                                            ...
                                            <View style={{ flexDirection: 'row' }}>
                                                ...
                                                <View style={{ marginLeft: 5 }}>
                                                    ...
                                                    <Text style={{
                                                        ...
                                                        color: warna.draculaOrchid,
                                                        fontWeight: '200',
                                                    }}>{this.state.product.materials}</Text>
                                                </View>
                                            </View>
                                            ...
                                            <View style={{ flexDirection: 'row' }}>
                                                ...
                                                <View style={{ marginLeft: 5 }}>
                                                    ...
                                                    <Text style={{
                                                        ...
                                                        color: warna.draculaOrchid,
                                                        fontWeight: '200',
                                                    }}>{this.state.product.colors}</Text>
                                                </View>
                                            </View>
                                    ...
                                    <View style={styles.itemPaddingDark}>
                                            ...
                                            <View style={{ flexDirection: 'row' }}>
                                                ...
                                                <View style={{ marginLeft: 5 }}>
                                                    <Text style={{
                                                        ...
                                                        fontWeight: '200',
                                                    }}> {(`Produk akan dikirimkan dari Kota ${this.state.city.city_name}, ${this.state.city.province}`).toUpperCase()}</Text>
                                                </View>
                                            </View>
                                ...
                                <View style={{ backgroundColor: warna.whiteLynx, justifyContent: 'center', height: 60, flexDirection: 'row', width: '100%' }}>
                                    <TouchableOpacity
                                        style={{
                                            width: 60,
