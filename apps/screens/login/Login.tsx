...
import { AsyncStorage,Text, View, StatusBar,Image, TextInput,TouchableOpacity, KeyboardAvoidingView, ActivityIndicator } from 'react-native'
...
class Login extends Component<any,any> {
    ...
    render() {
        ...
        const  handleLogin = ()=>{
            ...
            sendFreelyHttpPOST(url,paramWeb,(response) => {
                let data = response.data;
                if(data.result.login){
                    this.props.setMemberProps(data.result);
                    AsyncStorage.setItem('member',JSON.stringify(response['data'].result))
